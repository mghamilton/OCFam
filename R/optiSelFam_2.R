...
optiSelFam2  <- function(candidate_parents,
                        ped,
                        indiv_contbn,
                        kinship_constraint,
                        step_interval = 0.1,
...
ped$AVAIL_BROOD <- ped$Indiv %in% candidate_parents$Indiv
...
get_lb_ub <- function(ped, indiv_contbn, line, max_parents_per_fam) {

  #exclude based on max_parents_per_fam

  ped <- ped[ped$AVAIL_OR_PAST_BROOD,]
